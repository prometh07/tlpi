...
/* mbuf is located in uninitialized data segment (bss)
 * so the executable merely needs to record the location
 * and size required for this segment; space is allocated
